...
# MAGIC %md
# MAGIC
# MAGIC # Altria UPC List - Tobacco Accessories (Bronze)
...
from open_commerce_data_pipelines.altria.pipelines.bronze.product import UpcListProductImportPipelineConfig, \
    UpcListTobaccoAccessoriesProductImportPipeline
...
pipeline = UpcListTobaccoAccessoriesProductImportPipeline(config)
